        ...
        <>
            <div style={{ margin: 70 }}>
                ...
                >
                    ...
                    <Row style={white}>
                        <ProFormText width={"xs"} placeholder="年份" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["startDate", "year"]} addonBefore={"起始时间"} addonAfter={"年"} />
                        <ProFormText width={"xs"} placeholder="月份" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["startDate", "month"]} addonAfter={"月"} />
                        <ProFormText width={"xs"} placeholder="日期" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["startDate", "day"]} addonAfter={"日"} />
                    </Row>
                    <Row style={gray}>
                        <ProFormText width={"xs"} placeholder="年份" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["expectFinishDate", "year"]} addonBefore={"起始时间"} addonAfter={"年"} />
                        <ProFormText width={"xs"} placeholder="月份" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["expectFinishDate", "month"]} addonAfter={"月"} />
                        <ProFormText width={"xs"} placeholder="日期" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["expectFinishDate", "day"]} addonAfter={"日"} />
                    </Row>
                    <Row style={white}>
                        <ProFormText width={"xs"} placeholder="年份" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["finishDate", "year"]} addonBefore={"起始时间"} addonAfter={"年"} />
                        <ProFormText width={"xs"} placeholder="月份" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["finishDate", "month"]} addonAfter={"月"} />
                        <ProFormText width={"xs"} placeholder="日期" style={{ width: 10 }} required rules={[{ required: true, message: '这是必填项' }]} name={["finishDate", "day"]} addonAfter={"日"} />
                    </Row>
                    <Row style={gray}>
                    ...
                    <Row style={white}>
                        ...
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 0]} />
                    </Row>
                    <Row style={gray}>
                        2.建议委托单位阅读《软件项目委托测试流程图和工作介绍》，了解申报流程
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 1]} />
                    </Row>
                    <Row style={white}>
                        3.根据《软件项目委托测试提交材料》，指导委托单位提交申报资料
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 2]} />
                    </Row>
                    <Title level={4}>2.填写《软件项目委托测试申请表》、《委托测试软件功能列表》，按《软件项目委托测试提交材料》提交材料</Title>
                    <Row style={gray}>
                        1.确保委托方应填内容正确、完备；纸质材料已盖公章
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 3]} />
                    </Row>
                    <Row style={white}>
                        2.明确委托方按《软件项目委托测试提交材料》提交材料
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 4]} />
                    </Row>
                    <Title level={4}>3.签订《软件项目委托测试合同》、《软件项目委托测试保密协议》</Title>
                    <Row style={gray}>
                        1.合同及保密协议内容、数量符合要求
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 5]} />
                    </Row>
                    <Row style={white}>
                        2.合同编号方式符合要求
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 6]} />
                    </Row>
                    ...
                    <Row style={gray}>
                        ...
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 7]} />
                    </Row>
                    <Title level={3}>三、实施测试</Title>
                    <Title level={4}>5.编制测试方案</Title>
                    <Row style={white}>
                        1.测试方案必须经实验室质量负责人审核，技术负责人批准方能生效。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 8]} />
                    </Row>
                    <Row style={gray}>
                        2.委托测试软件介绍：简要介绍委托测试软件的功能特点、应用行业及技术特性等。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 9]} />
                    </Row>
                    <Row style={white}>
                        3.软件功能：以委托单位提供的功能列表为依据，以表格形式列出所有功能项目，并对功能列表的各功能项目按照层次关系进行编号，以便于标识。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 10]} />
                    </Row>
                    <Row style={gray}>
                        ...
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 11]} />
                    </Row>
                    <Row style={white}>
                        5.参考文档：列出编制本方案所参考的标准、规范及用户文档等的名称、作者、类型、版本/标识号。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 12]} />
                    </Row>
                    <Title level={4}>6.搭建测试环境</Title>
                    <Row style={gray}>
                        1.实验室按照委托方提供的委托测试软件运行环境搭建测试环境
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 13]} />
                    </Row>
                    ...
                    <Row style={white}>
                        ...
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 14]} />
                    </Row>
                    <Row style={gray}>
                        2.对文档的测试：要从完整性、正确性、一致性、易理解性、易浏览性和外观质量六个方面，对用户文档进行评审。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 15]} />
                    </Row>
                    <Row style={white}>
                        3.对测试过程观察到的结果进行如实记录，对发现的问题整理成问题清单；
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 16]} />
                    </Row>
                    <Title level={4}>8.编制测试报告</Title>
                    <Row style={gray}>
                        1.根据《软件项目委托测试报告编制作业指导书》和测试结果编制测试报告。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 17]} />
                    </Row>
                    <Row style={white}>
                        2.检查测试报告，并填写《报告检查表》。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 18]} />
                    </Row>
                    <Row style={gray}>
                        3.测试报告的编码请参阅《测试报告编码规则》
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 19]} />
                    </Row>
                    <Row style={white}>
                        4.报告审查：在分发报告前，应按实验室质量管理程序对报告进行严格审查。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 20]} />
                    </Row>
                    ...
                    <Row style={gray}>
                        ...
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 21]} />
                    </Row>
                    <Row style={white}>
                        2.归档资料同时填写《软件项目委托测试资料清单》，打印《软件委托测试资料标签》并编号号码，贴于档案盒制定位置。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 22]} />
                    </Row>
                    <Row style={gray}>
                        3.该检查表与本次软件委托测试归档资料一同归档，与《软件项目委托测试资料目录》、《软件项目委托测试试资料清单》一起，作为软件委托测试测试工作的检查、资料查询的主要依据。
                        <ProFormText label="确认" required rules={[{ required: true, message: "这是必填项" }]} name={["conclusion", 23]} />
                    </Row>

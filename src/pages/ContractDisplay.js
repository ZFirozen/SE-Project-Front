        ...
        <>
            <div style={{ margin: 70 }}>
                ...
                >
                    ...
                    <Row style={gray}>
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={"targetSoftware"} addonBefore={"乙方按照国家软件质量测试标准和测试规范，完成甲方委托的软件"}
                            addonAfter={"(下称受测软件)的质量特性,进行测试，并出具相应的测试报告。"} disabled/>
                    </Row>
                    <br />
                    ...
                    <Row style={gray}>
                        <ProFormDigit required rules={[{ required: false, message: "这是必填项" }]} name={"price"} width={"xs"} addonBefore={"本合同软件测试费用为人民币"}
                            addonAfter={"（¥元）。"} disabled/><br />
                    </Row>
                    <br />
                    ...
                    <Row style={gray}>
                        <ProFormDigit required rules={[{ required: false, message: "这是必填项" }]} name={"totalWorkingDays"} width={"xs"} addonBefore={"1.	本次测试的履行期限为合同生效之日起"}
                            addonAfter={"个自然日内完成。"} disabled/><br />
                    </Row>
                    <Row style={gray}>
                    ...
                    <Row style={gray}>
                        <ProFormDigit required rules={[{ required: false, message: "这是必填项" }]} name={"rectificationLimit"} width={"xs"} addonBefore={"在整个测试过程中，整改次数限于"}
                            addonAfter={"次，"} disabled/>
                        <ProFormDigit required rules={[{ required: false, message: "这是必填项" }]} name={"rectificationDaysEachTime"} width={"xs"} addonBefore={"每次不超过"}
                            addonAfter={"天。"} disabled/><br />
                    </Row>
                    <Row style={gray}>
                    ...
                    <Row style={gray}><div>
                        ...
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "companyEN"]} label="单位全称（英文）" disabled /></div></Row>
                    <Row style={white}><div>
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "representative"]} label="授权代表" disabled />
                        <ProFormDatePicker required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "sigDate"]} label="签章日期" disabled /></div></Row>
                    <Row style={gray}><div>
                        ...
                        <ProFormText required rules={[{ required: isCustomer, message: "这是必填项" }, { type: "email", message: "请输入正确邮箱格式" }]} name={["partyA", "contactEmail"]} label="联系人邮箱" disabled /></div></Row>
                    <Row style={white}><div>
                        ...
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "companyAddress"]} label="单位地址" disabled /></div></Row>
                    <Row style={gray}><div>
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "zipCode"]} label="邮编" disabled />
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "fax"]} label="传真" disabled /></div></Row>
                    <Row style={white}><div>
                        ...
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyA", "accountName"]} label="账号" disabled /></div></Row>
                    <br />
                    ...
                    <Row style={gray}><div>
                        ...
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "companyEN"]} label="单位全称（英文）" disabled /></div></Row>
                    <Row style={white}><div>
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "representative"]} label="授权代表" disabled />
                        <ProFormDatePicker required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "sigDate"]} label="签章日期" disabled /></div></Row>
                    <Row style={gray}><div>
                        ...
                        <ProFormText required rules={[{ required: isMarketer, message: "这是必填项" }, { type: "email", message: "请输入正确邮箱格式" }]} name={["partyB", "contactEmail"]} label="联系人邮箱" disabled /></div></Row>
                    <Row style={white}><div>
                        ...
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "companyAddress"]} label="单位地址" disabled /></div></Row>
                    <Row style={gray}><div>
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "zipCode"]} label="邮编" disabled />
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "fax"]} label="传真" disabled /></div></Row>
                    <Row style={white}><div>
                        ...
                        <ProFormText required rules={[{ required: false, message: "这是必填项" }]} name={["partyB", "accountName"]} label="账号" disabled /></div></Row>
                    <br />
                </ProForm>
            </div>
        </>

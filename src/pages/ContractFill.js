        ...
        <>
            <div style={{ margin: 70 }}>
                ...
                >
                    ...
                    <Row style={gray}>
                        <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"price"} width={"xs"} addonBefore={"本合同软件测试费用为人民币"}
                            addonAfter={"（¥元）。"} /><br />
                    </Row>
                    <br />
                    ...
                    <Row style={gray}>
                        <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"totalWorkingDays"} width={"xs"} addonBefore={"1.	本次测试的履行期限为合同生效之日起"}
                            addonAfter={"个自然日内完成。"} /><br />
                    </Row>
                    <Row style={gray}>
                    ...
                    <Row style={gray}>
                        <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"rectificationLimit"} width={"xs"} addonBefore={"在整个测试过程中，整改次数限于"}
                            addonAfter={"次，"} />
                        <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"rectificationDaysEachTime"} width={"xs"} addonBefore={"每次不超过"}
                            addonAfter={"天。"} /><br />
                    </Row>
                    <Row style={gray}>

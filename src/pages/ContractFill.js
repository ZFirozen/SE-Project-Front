                ...
                <PageContainer title="合同填写">
                    ...
                    >
                        ...
                        <Row style={white}>
                            ...
                            <ProFormText required rules={[{ required: true, message: "这是必填项" }]} name={"targetSoftware"} />
                        ...
                        <Row style={white}>
                            本合同软件测试费用为人民币
                            <ProFormDigit required rules={[{ required: false, message: "这是必填项" }]} name={"price"} width={"xs"} />
                            （¥元）。
                        </Row>
                        <br />
                        ...
                        <Row style={white}>
                            1.本次测试的履行期限为合同生效之日起
                            <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"totalWorkingDays"} width={"xs"} />
                            个自然日内完成。
                            <br />
                        </Row>
                        <Row style={white}>
                        ...
                        <Row style={white}>
                            在整个测试过程中，整改次数限于
                            <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"rectificationLimit"} width={"xs"} />
                            次，每次不超过
                            <ProFormDigit required rules={[{ required: true, message: "这是必填项" }]} name={"rectificationDaysEachTime"} width={"xs"} />
                            天。<br />
                        </Row>
                        <Row style={white}>

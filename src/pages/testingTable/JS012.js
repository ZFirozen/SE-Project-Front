            ...
            <div style={{ margin: 70 }}>
                        ...
                        if (typeof testId !== "undefined") {
                            return axios.get("/api/test/" + testId)
                                .then((project) => {
                                    ...
                                    console.log(123)
                                    entrustTestReviewId = project.data.projectFormIds.entrustTestReviewId
                                    return project.data;
                                }).then((projectdata) => {
                                    return axios.get("/api/review/entrustTest/" + projectdata.projectFormIds.entrustTestReviewId)
                                        .then((response) => {
                ...
                >
                    ...
                    <Row style={white}>
                        ...
                        <ProFormText label="确认" name={["conclusion", 0]} />
                    </Row>
                    <Row style={gray}>
                        2.建议委托单位阅读《软件项目委托测试流程图和工作介绍》，了解申报流程
                        <ProFormText label="确认" name={["conclusion", 1]} />
                    </Row>
                    <Row style={white}>
                        3.根据《软件项目委托测试提交材料》，指导委托单位提交申报资料
                        <ProFormText label="确认" name={["conclusion", 2]} />
                    </Row>
                    <Title level={4}>2.填写《软件项目委托测试申请表》、《委托测试软件功能列表》，按《软件项目委托测试提交材料》提交材料</Title>
                    <Row style={gray}>
                        1.确保委托方应填内容正确、完备；纸质材料已盖公章
                        <ProFormText label="确认" name={["conclusion", 3]} />
                    </Row>
                    <Row style={white}>
                        2.明确委托方按《软件项目委托测试提交材料》提交材料
                        <ProFormText label="确认" name={["conclusion", 4]} />
                    </Row>
                    <Title level={4}>3.签订《软件项目委托测试合同》、《软件项目委托测试保密协议》</Title>
                    <Row style={gray}>
                        1.合同及保密协议内容、数量符合要求
                        <ProFormText label="确认" name={["conclusion", 5]} />
                    </Row>
                    <Row style={white}>
                        2.合同编号方式符合要求
                        <ProFormText label="确认" name={["conclusion", 6]} />
                    </Row>
                    ...
                    <Row style={gray}>
                        ...
                        <ProFormText label="确认" name={["conclusion", 11]} />
                    </Row>
                    <Row style={white}>
                        5.参考文档：列出编制本方案所参考的标准、规范及用户文档等的名称、作者、类型、版本/标识号。
                        <ProFormText label="确认" name={["conclusion", 12]} />
                    </Row>
                    <Title level={4}>6.搭建测试环境</Title>
                    <Row style={gray}>
                        1.实验室按照委托方提供的委托测试软件运行环境搭建测试环境
                        <ProFormText label="确认" name={["conclusion", 13]} />
                    </Row>
                    ...
                    <Row style={white}>
                        ...
                        <ProFormText label="确认" name={["conclusion", 14]} />
                    </Row>
                    <Row style={gray}>
                        2.对文档的测试：要从完整性、正确性、一致性、易理解性、易浏览性和外观质量六个方面，对用户文档进行评审。
                        <ProFormText label="确认" name={["conclusion", 15]} />
                    </Row>
                    <Row style={white}>
                        3.对测试过程观察到的结果进行如实记录，对发现的问题整理成问题清单；
                        <ProFormText label="确认" name={["conclusion", 16]} />
                    </Row>
                    <Title level={4}>8.编制测试报告</Title>
                    <Row style={gray}>
                        1.根据《软件项目委托测试报告编制作业指导书》和测试结果编制测试报告。
                        <ProFormText label="确认" name={["conclusion", 17]} />
                    </Row>
                    <Row style={white}>
                        2.检查测试报告，并填写《报告检查表》。
                        <ProFormText label="确认" name={["conclusion", 18]} />
                    </Row>
                    <Row style={gray}>
                        3.测试报告的编码请参阅《测试报告编码规则》
                        <ProFormText label="确认" name={["conclusion", 19]} />
                    </Row>
                    <Row style={white}>
                        4.报告审查：在分发报告前，应按实验室质量管理程序对报告进行严格审查。
                        <ProFormText label="确认" name={["conclusion", 20]} />
                    </Row>

...
for i in tn:
    i.send_keys("2")
    time.sleep(0.2)
driver.find_element(By.ID,'partyA_contactEmail').send_keys("@2.com")
time.sleep(1)
driver.find_element(By.ID,'signedDate').send_keys("2022-07-07")
time.sleep(1)
driver.find_element(By.ID,'signedDate').send_keys(Keys.ENTER)
time.sleep(1)
driver.find_element(By.ID,'partyA_sigDate').send_keys("2022-07-07")
time.sleep(1)
driver.find_element(By.ID,'partyA_sigDate').send_keys(Keys.ENTER)
time.sleep(1)

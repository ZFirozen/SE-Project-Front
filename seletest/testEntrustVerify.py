...
fpry[7].click()
time.sleep(1)
driver.find_element(By.CSS_SELECTOR, "[class='ant-input ant-input-lg']").send_keys("test")
tb = driver.find_elements(By.CSS_SELECTOR, "[class='ant-input ant-input-lg']")
for i in tb:
    i.send_keys("1")
driver.find_element(By.CSS_SELECTOR, "[class='ant-btn ant-btn-primary ant-btn-lg']").send_keys(Keys.ENTER)
input()